// Purpose: Main file that runs the application
const { Department, Role, Employee } = require("./Models");

// Importing sequelize (for database connection)
const sequelize = require("./connection");

// Importing inquirer (for prompts)
const inquirer = require("inquirer");

// Importing console.table (for formatting tables)
...
const updateEmployeeRole = async () => {
  ...
  inquirer
    ...
    // Takes in user inputs and adds answers to database (updates role)
    .then((answer) => {
      ...
      Employee.update(answer, {
        ...
        // Fires off prompts after updating database with new role
        options();
      });
    });
};